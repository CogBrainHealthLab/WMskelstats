...
#' @title Formula reader
#'
#' @description Function reading dataset and formula arguments and deducing the contrast, random or model objects from a linear formula.
#' @param formula A string or formula object describing the predictors to be fitted against the voxel-wise data:
#' - The dependent variable is not needed, as it will always be the voxel-wise data values. 
...
#'
#' @returns A list object containing the model, contrast and random data.frame.
#' 
#' 
